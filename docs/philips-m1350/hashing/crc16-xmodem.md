...
This page contains the CRC-16/XMODEM entry from the RevEng CRC catalogue, which matches the repository implementation in `source/MDI.Philips.M1350/IO/Hashing/Crc16.cs`.
